...
<body class="flex gap-20 items-center h-[100vh] bg-[#1A1F2B] px-28">
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="flex gap-5 mt-5">
            <a href="pages/auth/pasien_login.php" class=" flex items-center justify-center bg-white px-10 py-3 font-medium">Login Pasien</a>
            <a href="pages/auth/dokter_login.php"
